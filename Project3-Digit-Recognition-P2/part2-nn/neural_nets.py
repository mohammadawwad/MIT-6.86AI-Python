...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Calculate the input and activation of the output layer
        ...
        # Calculate the gradient of the error with respect to the output layer
        output_layer_error = error * np.vectorize(output_layer_activation_derivative)(output)
